...
val EfficientStringKeyMapTest by testSuite {
    testSuite("Empty map") {
    ...
    testSuite("NElements map (5+ elements)") {
        test("returns correct values for all keys") {
            val map =
    ...
    testSuite("Map interface methods") {
    ...
    testSuite("Very long keys (>= 64 chars)") {
