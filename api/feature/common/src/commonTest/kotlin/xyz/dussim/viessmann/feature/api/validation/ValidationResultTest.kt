...
val ValidationResultTest by testSuite {
    testSuite("Valid()") {
    ...
    testSuite("Invalid with single value") {
    ...
    testSuite("Invalid with array of values") {
        test("isInvalid returns true") {
    ...
    testSuite("ValidationResult.of() with no arguments") {
        test("returns Valid") {
            ValidationResult.of<String>().isInvalid shouldBe false
        }
    }

    testSuite("ValidationResult.of() with single error") {
    ...
    testSuite("ValidationResult.of() with single result") {
    ...
    testSuite("ValidationResult.of() combining 2 results") {
    ...
    testSuite("ValidationResult.of() combining 3 results") {
    ...
    testSuite("ValidationResult.of() combining 4 results") {
        test("returns Valid when all are Valid") {
    ...
    testSuite("ValidationResult.of() combining 5 results") {
        test("returns Valid when all are Valid") {
    ...
    testSuite("ValidationResult.of() combining 6 results") {
        test("returns Valid when all are Valid") {
    ...
    testSuite("ValidationResult.of() combining 7 results") {
        test("returns Valid when all are Valid") {
    ...
    testSuite("ValidationResult.of() combining 8 results") {
        test("returns Valid when all are Valid") {
    ...
    testSuite("ValidationResult.of() combining 9 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 10 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 11 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 12 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 13 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 14 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 15 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("ValidationResult.of() combining 16 results") {
        test("returns Valid when all are Valid") {
            val result =
                ValidationResult.of(
                    Valid<String>(),
    ...
    testSuite("edge cases for of() with mixed valid/invalid") {
