...
val RulesTest by testSuite {
    ...
    testSuite("listDoublePropertyRule") {
    ...
    testSuite("listStringPropertyRule") {
    ...
    testSuite("listDeviceErrorPropertyRule") {
    ...
    testSuite("listZigbeeDeviceStatusPropertyRule") {
    ...
    testSuite("listRoomActorPropertyRule") {
    ...
    testSuite("listDevicePropertyRule") {
    ...
    testSuite("objectOtherRoomConfigurationPropertyRule") {
    ...
    testSuite("schedulePropertyRule") {
    ...
    testSuite("numberOfParametersRule") {
    ...
    testSuite("numberConstraintsRule") {
    ...
    testSuite("booleanConstraintsRule") {
    ...
    testSuite("scheduleConstraintsRule") {
    ...
    testSuite("energyMatrixConstraintsRule") {
    ...
    testSuite("arrayNumberConstraintsRule") {
    ...
    testSuite("arrayStringConstraintsRule") {
    ...
    testSuite("arrayBooleanConstraintsRule") {
    ...
    testSuite("arrayObjectConstraintsRule") {
    ...
    testSuite("arrayUnknownConstraintsRule") {
    ...
    testSuite("objectConstraintsRule") {
