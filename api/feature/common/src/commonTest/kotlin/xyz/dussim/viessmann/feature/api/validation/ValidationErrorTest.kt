...
val ValidationErrorTest by testSuite {
    testSuite("MissingComponent") {
    ...
    testSuite("ComponentTypeMismatch") {
        test("stores name and expectedActualClass") {
    ...
    testSuite("NumberOfParametersMismatch") {
    ...
    testSuite("ValidationError as sealed interface") {
