...
class IntToObjectMapTest :
    FunSpec({
        ...
        context("Map with 3+ elements (IntToObjectMapN)") {
        ...
        context("Map with different value types") {
        ...
        context("updating existing keys in MapN") {
