...
private typealias OfFunctionSixteen<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
...
open class ValidationResultOfSixteenBenchmark {
    ...
    private val invalid16: ValidationResult<String> = Invalid("error16")
    private val invalidMulti: ValidationResult<String> = Invalid(arrayOf("errorA", "errorB", "errorC"))

    private var ofFunction: OfFunctionSixteen<String> = { _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ -> ValidationResult.Valid }
    ...
    private var r16: ValidationResult<String> = valid
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16))
    }
}
