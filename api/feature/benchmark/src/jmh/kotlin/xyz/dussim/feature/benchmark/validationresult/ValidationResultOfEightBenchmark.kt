...
private typealias OfFunctionEight<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
...
@Fork(value = 1)
open class ValidationResultOfEightBenchmark {
    ...
    private var ofFunction: OfFunctionEight<String> = { _, _, _, _, _, _, _, _ -> ValidationResult.Valid }
    ...
    fun setup() {
        ofFunction =
            when (implementation) {
                Implementation.CURRENT -> ::ofCurrentEight
                Implementation.ALTERNATIVE -> ::ofAlternativeEight
            }
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3, r4, r5, r6, r7, r8))
    }
}
