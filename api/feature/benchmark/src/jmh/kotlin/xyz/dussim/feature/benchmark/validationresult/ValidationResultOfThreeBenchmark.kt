...
private typealias OfFunctionThree<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
) -> ValidationResult<E>
...
@Fork(value = 1)
open class ValidationResultOfThreeBenchmark {
    ...
    private var ofFunction: OfFunctionThree<String> = { _, _, _ -> ValidationResult.Valid }
    ...
    fun setup() {
        ofFunction =
            when (implementation) {
                Implementation.CURRENT -> ::ofCurrentThree
                Implementation.ALTERNATIVE -> ::ofAlternativeThree
            }
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3))
    }
}
