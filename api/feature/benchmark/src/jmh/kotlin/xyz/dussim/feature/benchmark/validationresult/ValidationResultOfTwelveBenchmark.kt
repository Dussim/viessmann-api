...
private typealias OfFunctionTwelve<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
...
@Fork(value = 1)
open class ValidationResultOfTwelveBenchmark {
    ...
    private var ofFunction: OfFunctionTwelve<String> = { _, _, _, _, _, _, _, _, _, _, _, _ -> ValidationResult.Valid }
    ...
    fun setup() {
        ofFunction =
            when (implementation) {
                Implementation.CURRENT -> ::ofCurrentTwelve
                Implementation.ALTERNATIVE -> ::ofAlternativeTwelve
            }
        when (scenario) {
            Scenario.ALL_VALID -> {
                r1 = valid
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12))
    }
}
