...
private typealias OfFunctionFive<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
...
open class ValidationResultOfFiveBenchmark {
    ...
    private var ofFunction: OfFunctionFive<String> = { _, _, _, _, _ -> ValidationResult.Valid }
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3, r4, r5))
    }
}
