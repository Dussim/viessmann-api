...
private typealias OfFunctionThirteen<E> = (
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
    ValidationResult<E>,
...
open class ValidationResultOfThirteenBenchmark {
    ...
    private var ofFunction: OfFunctionThirteen<String> = { _, _, _, _, _, _, _, _, _, _, _, _, _ -> ValidationResult.Valid }
    ...
    fun benchmark(blackHole: Blackhole) {
        blackHole.consume(ofFunction(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13))
    }
}
