...
open class SuiteState : StableValidationState(StableSize.LARGE)
...
@Fork(value = 3)
@Suppress("unused")
open class StableLargeValidationBenchmark {
    @Benchmark
    fun valid(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableLargeFailFastValidationBenchmark {
    @Benchmark
    fun valid(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableLargeConstructionBenchmark {
    @Benchmark
    fun validOrNull(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableLargeNonThrowingRejectionBenchmark {
    @Benchmark
...
@Fork(value = 3)
@Suppress("unused")
open class StableLargeThrowingConstructionBenchmark {
    @Benchmark
