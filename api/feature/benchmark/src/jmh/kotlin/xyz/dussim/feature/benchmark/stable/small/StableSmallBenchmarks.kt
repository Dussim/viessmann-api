...
open class SuiteState : StableValidationState(StableSize.SMALL)
...
@Fork(value = 3)
@Suppress("unused")
open class StableSmallValidationBenchmark {
    @Benchmark
    fun valid(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableSmallFailFastValidationBenchmark {
    @Benchmark
    fun valid(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableSmallConstructionBenchmark {
    @Benchmark
    fun validOrNull(
        state: SuiteState,
        blackhole: Blackhole,
...
@Fork(value = 3)
@Suppress("unused")
open class StableSmallNonThrowingRejectionBenchmark {
    @Benchmark
...
@Fork(value = 3)
@Suppress("unused")
open class StableSmallThrowingConstructionBenchmark {
    @Benchmark
