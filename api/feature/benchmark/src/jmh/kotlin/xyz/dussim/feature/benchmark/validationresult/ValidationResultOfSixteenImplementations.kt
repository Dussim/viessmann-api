...
fun <E> ofCurrentSixteen(
    ...
    if (!result1.isInvalid && !result2.isInvalid && !result3.isInvalid && !result4.isInvalid &&
        ...
        !result13.isInvalid && !result14.isInvalid && !result15.isInvalid && !result16.isInvalid
    ) {
        return Valid
    }
    val capacity =
...
fun <E> ofAlternativeSixteen(
    ...
    val mask =
        result1.invalidFlag or (result2.invalidFlag shl 1) or (result3.invalidFlag shl 2) or
            ...
            (result10.invalidFlag shl 9) or (result11.invalidFlag shl 10) or (result12.invalidFlag shl 11) or
            (result13.invalidFlag shl 12) or (result14.invalidFlag shl 13) or (result15.invalidFlag shl 14) or
